                        ...
                        {couponData.map((field:string, index:number) =>
                            index % 2 === 0 ?
                                <div key={index} className='flex'>
                                    ...
                                    <div onClick={() => setCouponData([...couponData, "", ""])} className='hover:bg-slate-900 w-12 cursor-pointer mb-3 rounded-full flex items-center justify-center'><Plus size={20} color="#ffffff" strokeWidth={3} /></div>
